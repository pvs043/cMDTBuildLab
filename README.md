...
* [MicrosoftDeploymentToolkit2013_x64] - Microsoft Deployment Toolkit (MDT) 2013 Update 2 (6.3.8330.1000)
...
[1. Getting Started with PowerShell Desired State Configuration (DSC)] (https://mva.microsoft.com/en-US/training-courses/getting-started-with-powershell-desired-state-configuration-dsc--8672?l=bNL1FoG1_9004984382)

[1.1 ?????? ?????? ?? ??????? ????????? ?????????? ????????? PowerShell (DSC)] (https://mva.microsoft.com/ru/training-courses/-powershell-dsc--8672?l=dlwgB3wFB_1704984382)
